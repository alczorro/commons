 ...
 *
 */
package cn.vlabs.commons.umt;

import cn.vlabs.commons.credential.PrincipalFactory;
import cn.vlabs.simpleAuth.GroupPrincipal;
import cn.vlabs.simpleAuth.Principal;
import cn.vlabs.simpleAuth.RolePrincipal;
import cn.vlabs.simpleAuth.UserPrincipal;

public class UMTPrinFactory implements PrincipalFactory<Principal> {
